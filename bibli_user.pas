...
{$R *.fmx}
 uses bibli,bibli_liv1,bibli_livpret;
 var
  pro,act,id:integer;
  Datmaj,req:string;
    ...
    if btMod.Enabled=true then
      begin
              ...
              datamodule2.fdQuerproc.SQL.Text:='select cprofil from profil where profil=:pro';
                 ...
                 datamodule2.fdQuerproc.Close;
                 datamodule2.fdQuerproc.SQL.Clear;
              datamodule2.fdQuerproc.SQL.Text:='UPDATE utilisateur SET telephone = :phon,email=:mel,pwd=:mdp,cprofil=:cpro,activite=:cact,datdeb=:deb,datfin=:fin, datmaj = :maj  WHERE iduser = :id' ;
     ...
     if btCre.Enabled=true then
      begin
                 ...
                 datamodule2.fdQuerproc.SQL.Text:='INSERT into utilisateur(nom,prenom,telephone,email,pwd,cprofil,activite,datdeb,datfin,datmaj) VALUES (:nom,:pren,:phon,:mail,:mdp,:cpro,:cact,:deb,:fin,:datmaj)';
...
begin
               ...
               datamodule2.fdQuerproc2.Close;
                 ...
                 req:= 'select iduser,telephone,email,pwd,datdeb,datfin,datmaj,';
